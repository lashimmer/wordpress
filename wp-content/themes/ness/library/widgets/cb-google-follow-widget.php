...
if ( ! class_exists( 'cb_google_follow_widget' ) ) {
    class cb_google_follow_widget extends WP_Widget {
    	...
    	function __construct() {
    		...
    		parent::__construct('google-follow', 'Ness Google+ Follow Widget', $widget_ops);
    	...
    	function widget($args, $instance) {
            ...
            if ( $googleplus != NULL ) {
                 ...
                 echo '<div class="g-page" data-theme="dark" data-width="360"  data-layout="landscape"  data-href="'. $googleplus .'"  data-showtagline="false" data-showcoverphoto="false" data-rel="publisher"></div> 
    ...
    ?>      
    		...
    		<input class="widefat" id="<?php echo $this->get_field_id( 'googleplus' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'googleplus' ) ); ?>" type="text" value="<?php echo esc_attr( $googleplus ); ?>" /></p>        
