...
if ( ! class_exists( 'cb_widget_social_media_icons' ) ) {
   class cb_widget_social_media_icons extends WP_Widget {
       ...
       function __construct() {
          ...
          parent::__construct('cb-social-media-widget', 'Ness Social Media Icons', $widget_ops);
        ...
        function widget($args, $instance) {
            ...
            $cb_facebook = apply_filters('widget_title', empty($instance['facebook']) ? '' : $instance['facebook'], $instance, $this->id_base);
            $cb_twitter = apply_filters('widget_title', empty($instance['twitter']) ? '' : $instance['twitter'], $instance, $this->id_base);
            $cb_youtube = apply_filters('widget_title', empty($instance['youtube']) ? '' : $instance['youtube'], $instance, $this->id_base);
        ...
        ?>
            <p>
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo $cb_title; ?>" />
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'type' ) ); ?>"><?php  echo "Icons Style:"; ?></label>
                <select id="<?php echo $this->get_field_id( 'type' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'type' ) ); ?>">
            ...
            <p>
                ...
                <input class="widefat" id="<?php echo $this->get_field_id( 'twitter' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'twitter' ) ); ?>" type="text" value="<?php echo $cb_twitter; ?>" />
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>">Facebook URL:</label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'facebook' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'facebook' ) ); ?>" type="text" value="<?php echo $cb_facebook; ?>" />
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>">Instagram URL:</label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'instagram' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'instagram' ) ); ?>" type="text" value="<?php echo $instagram; ?>" />
            </p>

            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'youtube' ) ); ?>">YouTube URL:</label>
                <input class="widefat" id="<?php echo $this->get_field_id( 'youtube' ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'youtube' ) ); ?>" type="text" value="<?php echo $cb_youtube; ?>" />
            </p>
