...
if ( ! class_exists( 'CB_WP_Widget_facebook_box' ) ) {
    ...
    class CB_WP_Widget_facebook_box extends WP_Widget {
    	...
    	function __construct() {
    		...
    		parent::__construct('facebook-box', 'Ness Facebook Box', $widget_ops);
    	...
    	function widget($args, $instance) {
    		...
    		$page = 'http://www.facebook.com/' . apply_filters('widget_page', empty($instance['page']) ? '' : $instance['page'], $instance, $this->id_base);
