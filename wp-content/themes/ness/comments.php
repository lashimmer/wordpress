...
<?php if ( have_comments() ) : ?>
    ...
    <h3 class="cb-footer-title cb-body-font cb-footer-title-sub"><?php _e('Comments', 'cubell'); ?></h3>

    <div class="cb-comment-reponses"><?php comments_number(__('No Responses', 'cubell'), __('One Response', 'cubell'), _n('% Response', '% Responses', get_comments_number(),'cubell') );?></div>
